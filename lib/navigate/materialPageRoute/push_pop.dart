  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        ...
        theme: ThemeData(
            ...
            navigatorKey: AppRouter.navigatorKey,   // Cách sử dụng navigatorKey : thay thế cho context 
        home: HomePage());
  }
}
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                MaterialPageRoute(
                    builder: (context) => const Screen1( argumentRoute:  "argumentRoute",)),  // Cách để có thể truyền tham số sang màn hình tiếp theo : sử dụng constructor
                    );
